            ...
            */
            ...
            <div id="tabWrap" style="margin: 0 0 0 10px;overflow:hidden;">
            	<dl style="overflow:hidden;">
					<dd style="float:left;margin-left:18px;"><a class="topRounded select" title="Information" href="<?php print base_path().$node->path; ?>">Information</a></dd>
					<dd style="float:left;margin-left:0px;"><a class="topRounded" title="Comments" href="<?php print base_path().$node->path; ?>/comments">Comments</a></dd>
					<div style="clear:left;"></div>
				</dl>            
            </div>
            
            <?php /* Event Details Content */ ?>
            <div style="margin-left:20px;margin-top:-12px;float: left;width: 554px;">
               <div>
